...
public final class BNRRateProvider implements ExchangeRateProvider {
     ...
     */
    private static final ProviderContext CONTEXT = ProviderContextBuilder.of(ExchangeRateProviderType.BNR.get(), RateType.DEFERRED)
            .set("providerDescription", ExchangeRateProviderType.BNR.getDescription()).build();
    ...
    public ExchangeRate getExchangeRate(ConversionQuery conversionQuery) {
        return new ExchangeRateBuilder(ExchangeRateProviderType.BNR.get(), RateType.ANY)
